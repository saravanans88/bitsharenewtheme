...
SuperSonicEx ağının herhangi bir miktarda BitVarlığı piyasaya sürmesi ve yeterli teminat 
...
SuperSonicEx ağı , ödünç aldığı bitVarlığın karşılığında yeterince teminatı bulunmayan 
...
Ödünç/kısa pozisyonunu kapamak için , ilk önce kişinin , SuperSonicEx ağına teslim 
