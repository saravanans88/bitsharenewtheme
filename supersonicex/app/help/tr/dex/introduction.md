...
Merkezsiz borsa (kısaca *DEX*) , SuperSonicEx ekosisteminde 
...
Bunlardan kısaca bahsetmek istiyoruz. SuperSonicEx DEX'de hepsi mevcut olmasina 
...
* **Güçler Ayrılığı** : 
  ...
  kimsenin sorumlu olmasını gerektirecek bir sebep yoktur. SuperSonicEx'de işlem 
...
* **Genel Birleşik Emir/Sipariş Defteri** :
  SuperSonicEx evrensel olduğu için , internet erişimi olan herkes  DEX'i alım-satım için 
...
* **Neredeyse Herşeyi Alıp-Satabilirsiniz** :
  SuperSonicEx DEX varlığın muhteviyatını bilmez , dolayısı ile **her türlü**  eşleşme ticareti 
...
* **Limit Yok** :
  SuperSonicEx protokolünün sizin ticaret deneyiminizi sınırlaması mümkün değildir.
* **Merkezsiz** :
  DEX (merkezsiz borsa) tüm dünyaya dağıtıktır. Bölece tek kırılma noktası 
  olmadığı gibi bu SuperSonicEx borsasının ticaret için 7/24 açık olduğu anlamına 
...
* **Hızlı** :
  Diğer merkezsiz ağların tersine SuperSonicEx DEX gerçek-zamanlı ticarete
   imkan tanır , sadece ışık hızı ve gezegenin büyüklüğü 
  ile sınırlıdır.
* **Kanıtlanabilir Emir Eşleştirme Algoritması** :
  SuperSonicEx DEX i nadir kılan şeylerden biri de ispatlanabilir emir eşleştirme 
...
* **Teminata Bağlanmış** :
  SuperSonicEx'in en büyük özelliklerinden biri de bitUSD, bitEUR, bitCNY gibi 
  *akıllıparalar*dır. Kolaylık olsun diye bu varlıklar cüzdan içerisinde USD,EUR,CNY 
  ...
  fiyatında hesap görümü için mevcut olabilen, **SuperSonicEx'in şirket hisseleri (BTS)** 
   vardır.