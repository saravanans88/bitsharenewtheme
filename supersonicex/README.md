...
This is a light wallet that connects to a SuperSonicEx API provided by the *witness_node* executable.
...
SuperSonicEx-UI depends node Node.js, and version 6+ is required.
...
```
git clone https://github.com/SuperSonicEx/SuperSonicEx-ui.git
cd SuperSonicEx-ui
```
...
## Testnet
By default SuperSonicEx-ui connects to the live SuperSonicEx network, but it's very easy to switch it to the testnet run by Xeroc. To do so, open the UI in a browser, go to Settings, then under Access, select the *Public Testnet Server* in the dropdown menu. You should also change the faucet if you need to create an account, the testnet faucet address is https://testnet.SuperSonicEx.eu.
